...
contract ChainlinkPriceOracleTest is Test {
    ...
    function testGetPriceAtTime() public {
        ...
        uint256 queryTime = block.timestamp > 1000 ? block.timestamp - 1000 : 0;
        uint256 price = oracle.getPriceAtTime(token0, token1, queryTime);
    ...
    function testGetLastUpdateTime() public {
        uint256 updateTime = block.timestamp > 100 ? block.timestamp - 100 : 0;
